	...
	<div class="main">
		<div class="left_side">
			...
			<div class="right_image">
				<a href="<?php echo site_url('topGrowth') ?>" target="_blank"><img src="images/11_05.jpg" width="350" height="478" alt="精英成长计划 尼德教育"/></a>
			</div>
		...
		<div class="right_side">
			<div class="gray_bg">
				...
				<marquee scrollamount="2" height="200" direction="up"  onMouseOver='this.stop()' onMouseOut='this.start()'>
					尼德教育的老师：您们好！<br/>我这次其中考试数学100分，语文100分，物理99分，较之前进步太大了，而且我现在特别喜欢学习，特别是物理，感觉越来越有兴趣，再不想以前那样枯燥无味了。<br/>
					其次我和父母关系也越来越好，我真没想到我父母能够做出改变，我们每天都很期待没月的访谈课程，更期待您们提供的学习指导方案。<br/>
					非常感谢尼德教育让我的学习成绩越来越好、成长越来越快乐。<br/>
