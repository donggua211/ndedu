...
<div id="mini_nav">
	<div class="font_12_18">
		...
		<a href="<?php echo site_url('evaluate') ?>" target="_blank">尼德测评系统</a>
	</div>
</div>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="261"><img src="images/logo.gif" width="261" height="88" alt="<?php echo SITE_NAME; ?>" /></td>
        <td align="left" valign="top"><img src="images/top_03.jpg" width="698" height="88" alt="<?php echo SITE_NAME; ?>" /></td>
      </tr>
</table>
...
<a href="<?php echo site_url('goldenLearningPlan') ?>">私人教育顾问</a></h4><div id="line"></div>
<h4 class="<?php echo ($nav_menu_id == 3) ? 'menuOn' : 'menuNo'; ?>" id="mod3" onmouseover="switchmodTag('mod','slidingList','3');this.blur();" style="width:125px;">
<a href="<?php echo site_url('multiSubjectTutorial') ?>">一对一多元化辅导</a></h4><div id="line"></div>
...
<a href="<?php echo site_url('school') ?>">尼德学堂</a></h4><div id="line"></div>
<h4 class="<?php echo ($nav_menu_id == 7) ? 'menuOn' : 'menuNo'; ?>" id="mod7" onmouseover="switchmodTag('mod','slidingList','7');this.blur();">
<a href="<?php echo site_url('aboutUs') ?>">关于尼德</a></a></h4><div id="line"></div></div>
...
<ul>
<li style="margin-left:30px;"> <a href="<?php echo site_url('multiSubjectTutorial') ?>"><font class="<?php echo ($CI->uri->segment(1) == 'multiSubjectTutorial') ? 'slidingBlock_hover' : '';?>">多元化学科辅导</font></a></li>
...
<ul>
<li style="margin-left:180px;"> <a href="<?php echo site_url('planEffect') ?>"><font class="<?php echo ($CI->uri->segment(1) == 'planEffect') ? 'slidingBlock_hover' : '';?>">规划效果</font></a></li>
...
<ul>
<li> <a href="<?php echo site_url('synBasis') ?>" style="margin-left:300px;"><font class="<?php echo ($CI->uri->segment(1) == 'synBasis') ? 'slidingBlock_hover' : '';?>">同步基础</font></a></li>
...
<ul>
<li style="margin-left:450px;"> <a href="<?php echo site_url('school') ?>"><font class="<?php echo ($CI->uri->segment(1) == 'school' && $CI->uri->segment(2) == false) ? 'slidingBlock_hover' : '';?>">教育文章</font></a></li>
...
<ul>
<li style="margin-left:380px;"> <a href="<?php echo site_url('aboutUs') ?>"><font class="<?php echo ($CI->uri->segment(1) == 'aboutUs') ? 'slidingBlock_hover' : '';?>">尼德简介</font></a></li>
