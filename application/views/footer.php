...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="border-top:1px solid #dbdbdb">
  <tr>
    <td height="67" align="center" valign="top" background="images/hjxxgh_56.jpg" class="font_gray" style="padding-top:8px; background-position:top; background-repeat:repeat-x"><a href="<?php echo site_url('aboutUs') ?>" target="_parent">关于我们</a>  &nbsp;|&nbsp; <a href="<?php echo site_url('contactUs') ?>" target="_parent">联系我们</a> &nbsp;|&nbsp; <a href="<?php echo site_url('siteMap') ?>" target="_parent">网站地图</a><br />
