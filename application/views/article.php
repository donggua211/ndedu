<div class="page_nav">
	当前位置：<a href="<?php site_url() ?>">首页</a> > <a href="<?php echo site_url('article/cat/'.$article_info['cat_id']) ?>"><?php echo $article_info['cat_name'] ?></a> > <?php echo $article_info['title'] ?>
</div>
<div class="article_content">
	...
	<div class="right">
		...
		<div class="text"><?php echo $article_info['content'] ?></div>
	</div>
</div>