<?php if( file_exists( 'images/cat_' . $cat['cat_id'] . 'jpg')): ?>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0" class="banner_border" style="margin-top:10px;">
  <tr>
    <td align="left"><img src="images/cat_<?php echo $cat['cat_id']; ?>.jpg" width="916" height="203" /></td>
  </tr>
</table>
<?php endif; ?>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" background="images/hjxxgh_10.jpg" class="mianbao">您所在位置： <a href="<?php echo site_url()?>">首页</a> &gt; <?php echo $cat['cat_name']; ?></td>
  </tr>
</table>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
