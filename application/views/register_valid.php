<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	您所在位置：<a href="<?php echo site_url('') ?>">首页</a> &gt; 注册验证
	</td>
  </tr>
</table>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="588"  width="600" align="left" valign="top">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td align="center" width="600" class="font_14_3" style="border:1px solid #FF8080;padding:5px">
					<img src="images/icon/warning.gif" style="vertical-align:middle"> <?php echo $notification ?>
				</td></tr>
			</table>
			<?php else: ?>
			<table border="0" cellspacing="0" cellpadding="0">
				<tr><td align="center" width="600" class="font_14_3" style="border:1px solid #71C610;padding:5px">
					<img src="images/icon/ok.gif" style="vertical-align:middle"> 尊敬的<?php echo $user_name ?>,  您的账户已经激活！<br/>
					<a href="<?php echo site_url('evaluate')?>"><strong>点击这里进入测评</strong></a>
				</td></tr>
			</table>
			<?php endif; ?>
		  </td>
