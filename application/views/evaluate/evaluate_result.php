...
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	您所在位置：<a href="<?php echo site_url('') ?>">首页</a> &gt; <a href="<?php echo site_url('evaluate') ?>">你的测评</a> &gt; <?php echo (isset($my_evaluate) && $my_evaluate) ? '<a href="'.site_url('evaluate/my').'">我的测评</a>' : '<a href="'.site_url('evaluate/'.$evaluate['evaluate_id']).'">'.$evaluate['name'].'</a>'?> &gt; <?php echo (isset($my_evaluate) && $my_evaluate) ? $evaluate['name'] : '测评结果'?>
	</td>
  </tr>
</table>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
