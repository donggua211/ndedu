		...
		<div id="listDiv" class="list-div">
			<table cellspacing='1' id="list-table">
				...
				<tr>
					...
					<td <?php echo $message['is_new'] == 1 ? 'style="font-weight:bold"' : '' ?> align="center"><?php echo $message['email']?></td>
					<td <?php echo $message['is_new'] == 1 ? 'style="font-weight:bold"' : '' ?> align="center"><?php echo $message['type']?></td>
