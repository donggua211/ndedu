...
<table style="table-layout: fixed" height="100%" cellspacing=0 cellpadding=0 width="100%" border=0>
  <tbody>
    ...
    <tr>
      ...
      <td><iframe id=main style="z-index: 1; visibility: inherit; overflow: auto; width: 100%; height: 100%" name=main src="<?php echo site_url("admin/student") ?>" frameborder=0 scrolling=yes></iframe></td>
    </tr>
  </tbody>
</table>
</body>
