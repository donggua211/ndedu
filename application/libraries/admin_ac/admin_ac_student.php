...
class Admin_Ac_Student extends Admin_Ac_Base 
{
	function Admin_Ac_Student($params)
	{
		...
		$this->group_student_status = array(
			...
			//客服老师
			GROUP_CS => array(STUDENT_STATUS_NOT_APPOINTMENT, STUDENT_STATUS_HAS_APPOINTMENT, STUDENT_STATUS_FINISHED),
			//客服主管
			GROUP_CS_D => array(STUDENT_STATUS_NOT_APPOINTMENT, STUDENT_STATUS_HAS_APPOINTMENT, STUDENT_STATUS_FINISHED),
			//咨询师
