...
class Calendar extends Controller {
	...
	function _get_all_staffs()
	{
		$filter['is_active'] = 1;
		$filter['is_delete'] = 0;
		$filter['group_id'] = array(GROUP_ADMIN, GROUP_SCHOOLADMIN, GROUP_CONSULTANT, GROUP_SUPERVISOR, GROUP_TEACHER_FULL, GROUP_CS, GROUP_CS_D, GROUP_SUYANG, GROUP_TEACHER_D, GROUP_CONSULTANT_D, GROUP_SUYANG_D);
