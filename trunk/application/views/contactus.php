<table width="920" border="0" align="center" cellpadding="0" cellspacing="0" class="banner_border" style="margin-top:10px;">
  <tr>
    <td align="left"><img src="images/contact_03.jpg" width="916" height="203" /></td>
  </tr>
</table>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30" background="images/hjxxgh_10.jpg" class="mianbao">您所在位置： <a href="<?php echo site_url() ?>">首页 </a>&gt; 联系我们</td>
  </tr>
</table>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
地铁10号线--双井站下车，往北0.5公里即是<br />
			...
			<form name="guestbook" action="<?php echo site_url().'/guestbook/submit/'?>" method="post" onSubmit="return checkTable(this);">
              <tr>
                <td height="36" align="left" valign="top" class="font_14" style=" padding-left:15px;"><table width="220" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                  <tr>
                  ...
                  <table width="560" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                    <tr>
                      <td width="70" valign="top">学习情况：</td>
                      <td  align="left"><label>
                        <textarea name="message" style="width:480px; height:115px; background-color:#FFFFFF; border:1px solid #CCCCCC; overflow:auto"></textarea>
                      </label></td>
                    </tr>
                  </table>
				  <table width="450" border="0" cellspacing="0" cellpadding="0" style="margin-top:8px;">
                    <tr>
					  ...
					  <td width="250" align="left">
						<table id="warningTable" border="0" cellspacing="0" cellpadding="0" style="display:none">
							  <tr>
    ...
    <td width="247" valign="top"><table width="247" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="247" border="0" cellpadding="0" cellspacing="0" class="gray_box">
        <tr>
		  ...
		  <table width="220" border="0" cellspacing="0" cellpadding="0" >
            <tr>
              <td height="21" background="images/ndjj_11.jpg" class="font_14" style="background-position:left; background-repeat:no-repeat; padding-left:30px;"><a href="<?php echo site_url('team') ?>">师资团队</a></td>
            </tr>
          </table>
		  <table width="200" border="0" cellpadding="0" cellspacing="0" class="font_right_content" style="margin-left:20px;">
            <tr>
