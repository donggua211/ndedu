<div id="header-div">
  <div id="logo-div"><a href="<?php echo site_url('ics') ?>"  target="_top">你的教育 -- 内部咨询系统</a></div>
  <div id="submenu-div">
    <ul>
      <li><a href="<?php echo site_url('admin/admin/logout') ?>"  target="_top">退出</a></li>
      <li style="border-left:none;"><a href="<?php echo site_url('admin') ?>" target="main-ics">返回你的后台</a></li>
