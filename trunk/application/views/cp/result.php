...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script language="javascript" type="text/javascript">
        function SetPrint(s,n) {
            ...
            document.all.factory.printing.footer = "你的全方位测评系统"; //页脚
...
<div>
    <div class="ExplainDiv border">
		...
		<tr><td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0"><tbody>
				...
				<tr><td class="ULTd" width="50%">测评单位：</td><td class="URTd" width="50%">你的教育</td></tr>
				...
				<tr><td colspan="2" class="TxTd">你的全方位测评系统</td></tr>
	...
	<div class="ExplainDiv border">
		...
		<div class="ExplainNeiDiv">
			<p>多年来，你的教育持续不断地专注于儿童教育行业，接触成千上万的孩子、家长、教师，你的人意识到目前教育最重要的问题就是“成人（家长和教师）不了解孩子，孩子不了解自己。”</p>
			...
			<p>你的教育全方位测评系统，覆盖小学、初中、高中三个学阶，特别是高中阶段分为应试测评、高考状态测评、高考专业选择测评。</p>
			<p>测评系统只是一个工具，可以帮助家长更加了解孩子的问题，可以帮助孩子更加了解自己的强弱项，同时给出专业的解决问题的方法和建议，但是不能代替家长和孩子自己的努力和勤奋！</p>
			我衷心祝愿你的教育全方位测评系统能为更多的家庭和孩子带去洒满阳光的童年。</p>
			<p style="text-align:right"><b>你的教育全体老师</b></p><br/><br/>
			
			<b>你的全方位测评系统统研发团队</b><br/><br/>
			<p>你的全方位测评系统由北京师范大学、北京大学多位教育心理专家、特高级教师参与指导，由你的教育IT事业部、咨询测评部、教学部骨干人员实际编写开发，根据严格的科学程序研发而成。</p><br/>
			<b>你的全方位测评系统提供内容支持的名师团队（节选部分人员，按姓氏首字母顺序排列）</b><br/><br/>
	...
	<div class="ExplainDiv">
		...
		elseif( $card_info['cat_id'] == 4 )
			echo  '你的高考状态测评内容包括：个性、环境（家庭、学校）、抗压适应、亲子关系、应试技巧、心理压力。共计155道题目，大约用时20～30分钟。';
		elseif( $card_info['cat_id'] == 5 )
			echo  '你的高考专业选择测评内容包括：个性，专业兴趣方向（理工和文史）、职业倾向、专业成就测试。共计234道题目，大约用时35～45分钟。';
		?>
		</p>
		</div>
