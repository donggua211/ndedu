<div id="order_main">
<form action="<?php echo site_url("cp_order"); ?>" method="post" id="orderstep2" onSubmit="return submit_order_step2(this);">
	<div class="order_nav">
	...
	<div class="order_block">
		<div class="order_block_title border_gray_solid">您的收货地址：<a href="javascript:void(0)" onclick="return update_action_submit('orderstep2');">[编辑我的收款人信息]</a></div>
		<div class="order_block_cotent">
			<span><?php echo ($city_name != $province_name ? $province_name.'省 ' : '').$city_name.'市 '.$district_name; ?> <?php echo $orderinfo['address'] ?></span>
			<span><?php echo $orderinfo['name'] ?>收</span>
			<span>邮编<?php echo $orderinfo['postcode'] ?></span>
		...
		<div class="order_block_cotent">
			产品名称：<?php echo $category_info['cat_name'] ?><?php echo ($orderinfo['order_type'] == CP_ORDER_TYPE_NORMAL) ? ' - '.get_cp_level_text($orderinfo['level']) : ''; ?><br/>
			购买数量：<?php echo (isset($orderinfo['order_num'])) ? $orderinfo['order_num'] :''; ?>套 * <?php echo number_format(($orderinfo['goods_fee']/$orderinfo['order_num']), 2, '.', '')  ?>元<br/>
			&nbsp;&nbsp;运&nbsp;&nbsp;&nbsp;&nbsp;费&nbsp;&nbsp;：<?php echo get_order_delivery_type_text($orderinfo['delivery_type']) ?> <?php echo number_format($orderinfo['ship_fee'], 2, '.', ''); ?>元
			<div class="quan_link">
