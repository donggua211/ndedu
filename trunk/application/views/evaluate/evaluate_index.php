<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	您所在位置：<a href="<?php echo site_url('') ?>">首页</a> &gt; 你的测评
	</td>
  </tr>
</table>
<table width="920" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<table width="662" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #c8c8c8; padding-bottom:6px;padding-left:20px;padding-top:10px">
        <tr>
          <td height="588"  width="600" align="left" valign="top">
			<?php if(!empty($evaluate_cat)): ?>
				<?php foreach($evaluate_cat as $cat_id=>$cat_name): ?>
					<table border="0" cellspacing="0" cellpadding="0" style="margin-top:10px">
						<tr height="35">
						  <td width="40" align="center" class=""><img src="images/icon/star.gif"></td>
						  <td align="left" class="font_143_orange"><?php echo $cat_name?></td>
						</tr>
					</table>
					<?php if(isset($evaluates[$cat_id]) && !empty($evaluates[$cat_id])): ?>
							<?php foreach($evaluates[$cat_id] as $evaluate): ?>
								<table width="600" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px dashed #c8c8c8;">
								  <tr>
									<td width="600" height="32" align="left" class="font_14" style="background-image:url(images/dott_15.jpg); background-repeat:no-repeat; background-position:5px center; padding-left:15px;"><a href="<?php echo site_url('evaluate/'.$evaluate['evaluate_id']) ?>"><?php echo $evaluate['name'] ?></a></td>
									<td width="160" align="right"><a href="<?php echo site_url('evaluate/'.$evaluate['evaluate_id']) ?>"><img src="images/do_evaluate.gif"></a></td>
								  </tr>
								</table>
