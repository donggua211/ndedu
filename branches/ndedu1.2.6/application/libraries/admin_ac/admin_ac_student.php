...
class Admin_Ac_Student extends Admin_Ac_Base 
{
	function Admin_Ac_Student($params)
	{
		...
		$this->group_student_status = array(
			...
			//客服老师
			GROUP_CS => array(STUDENT_STATUS_NOT_APPOINTMENT, STUDENT_STATUS_HAS_APPOINTMENT, STUDENT_STATUS_SIGNUP, STUDENT_STATUS_LEARNING, STUDENT_STATUS_FINISHED),
			//客服主管
			GROUP_CS_D => array(STUDENT_STATUS_NOT_APPOINTMENT, STUDENT_STATUS_HAS_APPOINTMENT, STUDENT_STATUS_SIGNUP, STUDENT_STATUS_LEARNING, STUDENT_STATUS_FINISHED),
			//咨询师
			GROUP_CONSULTANT => array(STUDENT_STATUS_NOT_APPOINTMENT, STUDENT_STATUS_HAS_APPOINTMENT, STUDENT_STATUS_LEARNING),	
			//咨询主管
			GROUP_CONSULTANT_D => array(STUDENT_STATUS_NOT_APPOINTMENT, STUDENT_STATUS_HAS_APPOINTMENT, STUDENT_STATUS_LEARNING),
			//素养课老师
			GROUP_SUYANG => array(STUDENT_STATUS_LEARNING),
			//素养课主管
			GROUP_SUYANG_D => array(STUDENT_STATUS_LEARNING),
			//教务老师
			...
			//学科主管			
			GROUP_TEACHER_D => array(STUDENT_STATUS_LEARNING),
			//学科老师（兼职）
