...
<div id="navigation" class="navigation">
	<a href="<?php echo site_url().'/admin/entry/info'?>">admin</a> &nbsp;»&nbsp; <a href="<?php echo site_url().'/admin/student/index'?>">学生管理</a> &nbsp;»&nbsp; 添加学生
</div>
<div style="padding:10px">
	...
	<form action="<?php echo site_url().'/admin/student/add'?>" method="post">
		...
		<input type="submit" value="添加学生" name="submit"> <input type="reset" value="重写" name="reset"><br/>
	</form>
</div>
