...
<div id="main">
	<div id="main_body">
		...
		<?php endif;?>
		<form action="<?php echo site_url('admin/ics/document_edit') ?>" method="post" name="addstaff">
		<table width="100%" id="shop_info-table">
			...
			<tr>
				<td class="narrow-label"><span class="notice-star"> * </span>tags: </td>
				<td>
		...
		<div class="button-div">
			<input type="hidden" value="<?php echo $document['document_id'];?>" name="document_id">
